...
const TTB_ADDR = "0x3504aAbaD5c18f180A1A14c3A7dE7eE9fe8bAaa8";
const FARM_ADDR = "0x46Deee7051EC4e0699FDA5B49307654963D667FC";
const USER_REF = "0xEaC13EEf0155931E80b87334bE8c72D0DAC17158"
...
class IDO{
    ...
    async index_page(type) {
        ...
        stake_result[7] = this.toNonExponential(Number(this.web3.utils.fromWei(stake_result[7])));
        stake_result[9] = this.toNonExponential(Number(this.web3.utils.fromWei(stake_result[9])));
    ...
    getQueryVariable(variable) {
        ...
        if(query.indexOf('?ref=') != -1 ){ //如果依然存在?ref=
          let pair  = query.split("?ref=")
          return pair[1]
        }
